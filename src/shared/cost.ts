...
export function roundCostBreakdown(cost: CostBreakdown): CostBreakdown {
  return {
    ...
    additionalCost: roundToMicroDollars(cost.additionalCost),
...
export function multiplyCostBreakdown(
  ...
  return {
    ...
    additionalCost: roundToMicroDollars(cost.additionalCost * multiplier),
...
export function addCostBreakdowns(
  ...
  return {
    ...
    additionalCost: a.additionalCost + b.additionalCost,
